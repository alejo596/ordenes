<template>
	<div class="container-fluid">
		...
		<div class="card border-success mt-1">
			...
			<div class="card-title text-white text-center bg-success"><h5><b>1. - Gestion de compra (O.T. N° {{numeroot}})</b></h5></div>
			<div class="card-body">	
																...
																<div class="card-body">
																	<div class="row">
																		...
																		<div class="col-12" v-if="de.fecha_inicio != null" style="font-size: 12px" >
																			...
																			<div class="row" v-if="de.verificar == 0" style="height: 54px;">
																				<div class="col-12">
	...
	<script>
		export default
		{
			...
			getOt()
			{
				axios.get('../../ordenesdecompra/'+this.id).then(response=>{
			...
			historialot(id)
			{
				axios.get('../../historialdecompras2/'+id).then(response=>{
					...
					console.log('toggleButton',this.toggleButton);
                       ...
                       for (var i = 0; i < this.header.length; i++) {
                       	if(parseInt(this.header[i].id_actividad) === 4 ){
